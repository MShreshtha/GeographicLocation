[Uploading REAMDE.md…]()
# This is prototype application which tells the distance between the server of source url and the destination passed. This is developed using Python's Django framework.
